...
import net.starlikeclient.minecraft.entities.ai.EntityAIEndCreeperSwell;

public class EntityEndCreeper extends EntityMob {
	...
	public EntityEndCreeper(World worldIn) {
		...
		this.tasks.addTask(2, new EntityAIEndCreeperSwell(this));
	...
	public void onDeath(DamageSource damagesource) {
		...
		} else if (damagesource.getEntity() instanceof EntityEndCreeper && damagesource.getEntity() != this
				&& ((EntityEndCreeper) damagesource.getEntity()).getPowered()
				&& ((EntityEndCreeper) damagesource.getEntity()).isAIEnabled()) {
			((EntityEndCreeper) damagesource.getEntity()).func_175493_co();
